      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stateData.map((state, index) => (
            <div 
              key={index}
              className="bg-white rounded-lg shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 p-6 cursor-pointer group hover:border-blue-300 transform hover:-translate-y-1"
            >
              {/* State Header */}
