...
const DumpsterCalculatorWithMaterials = () => {
  ...
  // Project sizes based on type - UPDATED FOR RESIDENTIAL
  ...
  const calculateSize = () => {
    ...
    const baseSize = {
      ...
      landscaping: { 
        small: 10,   // Small residential cleanup
        medium: 15,  // Medium residential
        large: 20    // Large residential (reduced from 25)
      },
      construction: { 
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-blue-50 to-green-50 rounded-2xl shadow-xl">
      {/* Header with Residential Disclaimer */}
        ...
        <div className="bg-blue-50 border border-blue-300 rounded-lg p-3 mx-auto max-w-2xl">
          <div className="flex items-center justify-center">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-blue-700 mt-1">This calculator is designed for typical home renovation and landscaping projects.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {currentStep === 2 && (
        <div className="bg-white rounded-xl p-6 shadow-lg">
          ...
          {/* Size Selection with Helper Text for Landscaping */}
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {getProjectSizes(formData.projectType).map((size) => (
                ...
                >
                  ...
                  {/* Add helper text for landscaping projects */}
        ...
        <div id="results-section" className="bg-white rounded-xl p-6 shadow-lg">
            ...
            {result.needsMultiple ? (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="text-center">
                  ...
                  {/* UPDATED: Enhanced Weight Warning */}
                    ...
                    <div className="flex items-start">
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-sm text-red-700 mt-1">
                          You selected extremely heavy materials (concrete/dirt/rock). This residential calculator recommends multiple loads due to DOT weight regulations. For projects involving large quantities of heavy materials, consider consulting a waste management professional for the most accurate sizing.
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          {(result.warnings.heavy || result.warnings.weightLimit) && (
            <div className="mb-6 space-y-3">
              {result.warnings.weightLimit && !result.needsMultiple && (
                <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              {result.warnings.multipleLoads && !result.needsMultiple && (
      ...
      <div className="mt-8 bg-gray-50 border border-gray-300 rounded-lg p-4">
        ...
        <p className="text-xs text-gray-600">
          This calculator provides estimates for typical residential renovation and landscaping projects only. Results are based on average material densities and standard residential project scopes. For commercial projects, construction sites, or unusually large residential projects, consult directly with waste management professionals for accurate sizing and permitting requirements. Actual dumpster capacity may vary based on local regulations, material types, and project specifics.
        </p>
      </div>
    </div>
  );
