      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 mb-6">
            Professional dumpster rentals serving the entire DFW metroplex
          </p>
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full">✓ Same Day Delivery</span>
            <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full">✓ DFW-Wide Coverage</span>
